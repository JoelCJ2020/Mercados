...
/**
 * <p>Clase Java para ProveedorType complex type.
 * 
...
@XmlSeeAlso({
    OutputProveedorCrear.class,
    OutputProveedorObtener.class,
    InputProveedorActualizar.class,
    InputProveedorCrear.class
})
