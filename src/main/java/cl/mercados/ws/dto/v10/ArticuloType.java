...
/**
 * <p>Clase Java para ArticuloType complex type.
 * 
...
@XmlSeeAlso({
    OutputArticuloCrear.class,
    OutputArticuloObtener.class,
    InputArticuloActualizar.class,
    InputArticuloCrear.class
})
public class ArticuloType {
